...
int openKeyboardIME() {
    ...
    jint resourses = vm->AttachCurrentThread(&env, &attachargs);
...
// этот слелал я
//bool Init(std::shared_ptr<sf::RenderWindow> window, bool loadDefaultFont) {
//	return Init(window, loadDefaultFont);
//}
