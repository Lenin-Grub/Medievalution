...
{
	// Проходим по всем пикселям изображения и находим средние координаты для пикселей цвета провинции
	int pixelCount = 0;
	int sumX = 0;
	int sumY = 0;
	...
	// Вычисляем средние координаты пикселей цвета провинции для определения центра провинции
