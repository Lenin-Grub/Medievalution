...
void AnimationDisplay::drawTopPanel()
{
...
void AnimationDisplay::drawSpriteSelector()
{
...
void AnimationDisplay::loadUnitAnimations(const std::string& unit_name)
{
    current_animation_name.clear();
...
void AnimationDisplay::drawAnimationsPanel()
{
...
void AnimationDisplay::drawFrameList()
{
...
void AnimationDisplay::drawFrameControls()
{
...
void AnimationDisplay::drawPlaybackControls()
{
    ImGui::BeginGroup();
    if (current_animation_name.empty())
    {
...
void AnimationDisplay::drawSpriteSheet()
{
...
void AnimationDisplay::removeFrame(const std::string& animationName, size_t index)
{
...
void AnimationDisplay::updateSelectedTileFromFrame()
{
...
void AnimationDisplay::addFrameFromSelectedTile()
{
...
void AnimationDisplay::applyDurationToAllFrames()
{
