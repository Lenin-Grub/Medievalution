...
{
    float zoom_factor = common::view.getSize().x / WindowSettings::getInstance().resolution.width;
    float adjusted_speed = WindowSettings::getInstance().camera_speed * zoom_factor;
